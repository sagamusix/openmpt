 ...
 project "lua"
  ...
  files {
     "../../include/lua-sol2/include/sol/compatibility/**.hpp",
     "../../include/lua-sol2/include/sol/detail/**.hpp",
     "../../include/lua-sol2/include/sol/stack/**.hpp",
     "../../include/lua-sol2/include/sol/utility/**.hpp",
     "../../include/lua-sol2/include/sol/**.hpp",
  }
