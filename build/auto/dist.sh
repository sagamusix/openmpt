...
function headercheck_cpp() {
	...
	if ${HEADERCHECK_COMPILER} ${HEADERCHECK_STANDARD} -c bin/empty.cpp -o bin/empty.${HEADERCHECK_NAME}.out > /dev/null 2>&1 ; then
		...
		echo 'int main() { return 0; }' >> bin/headercheck.cpp
		echo " ${HEADERCHECK_COMPILER} ${HEADERCHECK_STANDARD} ${HEADERCHECK_STDLIB}"
		${HEADERCHECK_COMPILER} ${HEADERCHECK_STANDARD} ${HEADERCHECK_STDLIB} ${HEADERCHECK_OPTIONS} -I. bin/headercheck.cpp -o bin/headercheck.${HEADERCHECK_NAME}.out 2>bin/headercheck.${HEADERCHECK_NAME}.err
		rm bin/headercheck.cpp
	fi
	rm bin/empty.cpp
}
...
#headercheck_cpp "clang++"      "clang++"   ""             "-stdlib=platform"  "-Wall -Wextra -Wpedantic -Werror"
#headercheck_cpp "clang++98"    "clang++"   "-std=c++98"   "-stdlib=platform"  "-Wall -Wextra -Wpedantic -Werror"
#headercheck_cpp "clang++03"    "clang++"   "-std=c++03"   "-stdlib=platform"  "-Wall -Wextra -Wpedantic -Werror"
#headercheck_cpp "clang++11"    "clang++"   "-std=c++11"   "-stdlib=platform"  "-Wall -Wextra -Wpedantic -Werror"
#headercheck_cpp "clang++14"    "clang++"   "-std=c++14"   "-stdlib=platform"  "-Wall -Wextra -Wpedantic -Werror"
headercheck_cpp "clang++17"    "clang++"   "-std=c++17"   "-stdlib=platform"  "-Wall -Wextra -Wpedantic -Werror"
headercheck_cpp "clang++20"    "clang++"   "-std=c++20"   "-stdlib=platform"  "-Wall -Wextra -Wpedantic -Werror"
headercheck_cpp "clang++23"    "clang++"   "-std=c++23"   "-stdlib=platform"  "-Wall -Wextra -Wpedantic -Werror"
#headercheck_cpp "clang++98gnu" "clang++"   "-std=gnu++98" "-stdlib=platform"  "-Wall -Wextra -Wpedantic -Werror"
#headercheck_cpp "clang++03gnu" "clang++"   "-std=gnu++03" "-stdlib=platform"  "-Wall -Wextra -Wpedantic -Werror"
#headercheck_cpp "clang++11gnu" "clang++"   "-std=gnu++11" "-stdlib=platform"  "-Wall -Wextra -Wpedantic -Werror"
#headercheck_cpp "clang++14gnu" "clang++"   "-std=gnu++14" "-stdlib=platform"  "-Wall -Wextra -Wpedantic -Werror"
headercheck_cpp "clang++17gnu" "clang++"   "-std=gnu++17" "-stdlib=platform"  "-Wall -Wextra -Wpedantic -Werror"
headercheck_cpp "clang++20gnu" "clang++"   "-std=gnu++20" "-stdlib=platform"  "-Wall -Wextra -Wpedantic -Werror"
headercheck_cpp "clang++23gnu" "clang++"   "-std=gnu++23" "-stdlib=platform"  "-Wall -Wextra -Wpedantic -Werror"
#headercheck_cpp "clang++"      "clang++"   ""             "-stdlib=libstdc++" "-Wall -Wextra -Wpedantic -Werror"
#headercheck_cpp "clang++98"    "clang++"   "-std=c++98"   "-stdlib=libstdc++" "-Wall -Wextra -Wpedantic -Werror"
#headercheck_cpp "clang++03"    "clang++"   "-std=c++03"   "-stdlib=libstdc++" "-Wall -Wextra -Wpedantic -Werror"
#headercheck_cpp "clang++11"    "clang++"   "-std=c++11"   "-stdlib=libstdc++" "-Wall -Wextra -Wpedantic -Werror"
#headercheck_cpp "clang++14"    "clang++"   "-std=c++14"   "-stdlib=libstdc++" "-Wall -Wextra -Wpedantic -Werror"
headercheck_cpp "clang++17"    "clang++"   "-std=c++17"   "-stdlib=libstdc++" "-Wall -Wextra -Wpedantic -Werror"
headercheck_cpp "clang++20"    "clang++"   "-std=c++20"   "-stdlib=libstdc++" "-Wall -Wextra -Wpedantic -Werror"
headercheck_cpp "clang++23"    "clang++"   "-std=c++23"   "-stdlib=libstdc++" "-Wall -Wextra -Wpedantic -Werror"
#headercheck_cpp "clang++98gnu" "clang++"   "-std=gnu++98" "-stdlib=libstdc++" "-Wall -Wextra -Wpedantic -Werror"
#headercheck_cpp "clang++03gnu" "clang++"   "-std=gnu++03" "-stdlib=libstdc++" "-Wall -Wextra -Wpedantic -Werror"
#headercheck_cpp "clang++11gnu" "clang++"   "-std=gnu++11" "-stdlib=libstdc++" "-Wall -Wextra -Wpedantic -Werror"
#headercheck_cpp "clang++14gnu" "clang++"   "-std=gnu++14" "-stdlib=libstdc++" "-Wall -Wextra -Wpedantic -Werror"
headercheck_cpp "clang++17gnu" "clang++"   "-std=gnu++17" "-stdlib=libstdc++" "-Wall -Wextra -Wpedantic -Werror"
headercheck_cpp "clang++20gnu" "clang++"   "-std=gnu++20" "-stdlib=libstdc++" "-Wall -Wextra -Wpedantic -Werror"
headercheck_cpp "clang++23gnu" "clang++"   "-std=gnu++23" "-stdlib=libstdc++" "-Wall -Wextra -Wpedantic -Werror"
#headercheck_cpp "clang++"      "clang++"   ""             "-stdlib=libc++"    "-Wall -Wextra -Wpedantic -Werror"
#headercheck_cpp "clang++98"    "clang++"   "-std=c++98"   "-stdlib=libc++"    "-Wall -Wextra -Wpedantic -Werror"
#headercheck_cpp "clang++03"    "clang++"   "-std=c++03"   "-stdlib=libc++"    "-Wall -Wextra -Wpedantic -Werror"
#headercheck_cpp "clang++11"    "clang++"   "-std=c++11"   "-stdlib=libc++"    "-Wall -Wextra -Wpedantic -Werror"
#headercheck_cpp "clang++14"    "clang++"   "-std=c++14"   "-stdlib=libc++"    "-Wall -Wextra -Wpedantic -Werror"
headercheck_cpp "clang++17"    "clang++"   "-std=c++17"   "-stdlib=libc++"    "-Wall -Wextra -Wpedantic -Werror"
headercheck_cpp "clang++20"    "clang++"   "-std=c++20"   "-stdlib=libc++"    "-Wall -Wextra -Wpedantic -Werror"
headercheck_cpp "clang++23"    "clang++"   "-std=c++23"   "-stdlib=libc++"    "-Wall -Wextra -Wpedantic -Werror"
#headercheck_cpp "clang++98gnu" "clang++"   "-std=gnu++98" "-stdlib=libc++"    "-Wall -Wextra -Wpedantic -Werror"
#headercheck_cpp "clang++03gnu" "clang++"   "-std=gnu++03" "-stdlib=libc++"    "-Wall -Wextra -Wpedantic -Werror"
#headercheck_cpp "clang++11gnu" "clang++"   "-std=gnu++11" "-stdlib=libc++"    "-Wall -Wextra -Wpedantic -Werror"
#headercheck_cpp "clang++14gnu" "clang++"   "-std=gnu++14" "-stdlib=libc++"    "-Wall -Wextra -Wpedantic -Werror"
headercheck_cpp "clang++17gnu" "clang++"   "-std=gnu++17" "-stdlib=libc++"    "-Wall -Wextra -Wpedantic -Werror"
headercheck_cpp "clang++20gnu" "clang++"   "-std=gnu++20" "-stdlib=libc++"    "-Wall -Wextra -Wpedantic -Werror"
headercheck_cpp "clang++23gnu" "clang++"   "-std=gnu++23" "-stdlib=libc++"    "-Wall -Wextra -Wpedantic -Werror"
rm -f bin/headercheck.*.out
rm -f bin/headercheck.*.err
