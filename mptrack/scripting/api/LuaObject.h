...
struct Obj
{
	Script &m_script;
	CModDoc &m_modDoc;
	size_t m_index;	// optional, for indexed objects (e.g. a sample)
	...
	Obj& operator= (const Obj &other) noexcept { MPT_ASSERT(&m_script == &other.m_script); m_index = other.m_index; return *this; }
	Obj& operator= (Obj &&other) noexcept { MPT_ASSERT(&m_script == &other.m_script); m_index = other.m_index; return *this; }
