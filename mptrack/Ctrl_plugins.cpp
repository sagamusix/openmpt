...
BOOL CCtrlPlugins::GetToolTipText(UINT uId, LPTSTR pszText)
{
	if(!pszText)
		return FALSE;
		...
		case IDC_EDIT16:
			{
				...
				_tcscpy(pszText, CModDoc::LinearToDecibels(gain ? gain : 10, 10.0));
			}
			return TRUE;
		case IDC_BUTTON5:
			_tcscpy(pszText, _T("Previous Plugin"));
			return TRUE;
		case IDC_BUTTON4:
			_tcscpy(pszText, _T("Next Plugin"));
			return TRUE;
	}
	return FALSE;
}
